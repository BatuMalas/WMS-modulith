/**
 * ============================================================
 * UC-03 Outbound Confirmation | Fase 100 RPS
 * ============================================================
 * Perintah:
 *   k6 run --out json=../results/uc03-100rps.json scripts/uc03-outbound-100rps.js
 */
...
export const options = {
  scenarios: {
    uc03_100rps: {
      ...
      tags: { scenario: 'UC-03-Outbound', phase: '100RPS' },
    },
  },
  thresholds: {
    ...STANDARD_THRESHOLDS,
...
export function setup() {
  console.log('┌─────────────────────────────────────────────────┐');
  console.log('│  UC-03 OUTBOUND  │  Fase: 100 RPS │  90 detik  │');
...
export function teardown() {
  console.log('✓ UC-03 | 100 RPS — Selesai. Cek hasil di: results/uc03-100rps.json');
}
