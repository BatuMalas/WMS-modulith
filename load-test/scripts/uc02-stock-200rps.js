/**
 * ============================================================
 * UC-02 Stock Adjustment | Fase 200 RPS
 * ============================================================
 * Perintah:
 *   k6 run --out json=../results/uc02-200rps.json scripts/uc02-stock-200rps.js
 */
...
export const options = {
  scenarios: {
    uc02_200rps: {
      ...
      tags: { scenario: 'UC-02-StockAdj', phase: '200RPS' },
    },
  },
  thresholds: {
    ...STANDARD_THRESHOLDS,
...
export function setup() {
  console.log('┌─────────────────────────────────────────────────┐');
  console.log('│  UC-02 STOCK ADJ │  Fase: 200 RPS │  120 detik │');
  console.log('└─────────────────────────────────────────────────┘');
...
export function teardown() {
  console.log('✓ UC-02 | 200 RPS — Selesai. Cek hasil di: results/uc02-200rps.json');
}
