/**
 * ============================================================
 * UC-01 Inbound | Fase 200 RPS
 * ============================================================
 * Perintah:
 *   k6 run --out json=../results/uc01-200rps.json scripts/uc01-inbound-200rps.js
 */
...
export const options = {
  scenarios: {
    uc01_200rps: {
      ...
      tags: { scenario: 'UC-01-Inbound', phase: '200RPS' },
    },
  },
  thresholds: {
    ...STANDARD_THRESHOLDS,
    ...
    'uc01_error_rate':       ['rate<0.15'],  // Sedikit lebih toleran di beban puncak
  },
...
export function setup() {
  console.log('┌─────────────────────────────────────────────────┐');
  console.log('│  UC-01 INBOUND  │  Fase: 200 RPS  │  120 detik │');
  console.log('└─────────────────────────────────────────────────┘');
...
export function teardown() {
  console.log('✓ UC-01 | 200 RPS — Selesai. Cek hasil di: results/uc01-200rps.json');
}
